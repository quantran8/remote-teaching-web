  ...
  <div class="sc-body">
    <div class="sc-content" ref="contentSectionRef">
      <div class="sc-content__top sc-teacher" ref="videoContainerRef">
        <div :id="teacher?.id" :class="!isOneToOne || studentIsOneToOne ? 'sc-teacher__video' : 'sc-teacher__not-visible'"></div>
		<div :class="isOneToOne && !studentIsOneToOne ? 'sc-teacher__video' : 'sc-teacher__not-visible'">
