...
export default defineComponent({
    ...
    setup() {
        ...
        const filterResources = (resources: ResourceMenuItem[]) => resources.filter((resource: ResourceMenuItem) => {
            if (resource.action) {
        ...
        const sortResources = (resources: ResourceMenuItem[]) => resources.sort((a, b) => {
