...
const AGORA_APP_ID = "da2d4c42cea04e30973bd4d6800dd468";
const AGORA_APP_CERTIFICATE = "7fc4785b0a4b44c7a7b095aea71bbc2d";
const AGORA_CUSTOMER_ID = "f0ca1e5533fc4f22b39a8fd970634f39";
const AGORA_CUSTOMER_SECRET = "9298bee82ea34a21ae5b7fba73719fb9";
...
export class AgoraClient implements AgoraClientSDK {
  ...
  initStream() {
    ...
    const spec: StreamSpec = {
      streamID: (this._client as any).clientId,
      audio: true,
      video: true,
    };
