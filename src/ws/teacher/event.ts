export enum TeacherWSEvent {
  ...
  EVENT_TEACHER_ANNOTATION_SET_BRUSHSTROKE = "EVENT_TEACHER_ANNOTATION_SET_BRUSHSTROKE",
  EVENT_TEACHER_ANNOTATION_CLEAR_BRUSHSTROKE = "EVENT_TEACHER_ANNOTATION_CLEAR_BRUSHSTROKE",
  EVENT_TEACHER_ANNOTATION_DELETE_BRUSHSTROKE = "EVENT_TEACHER_ANNOTATION_DELETE_BRUSHSTROKE",
  EVENT_TEACHER_ANNOTATION_SET_STICKER = "EVENT_TEACHER_ANNOTATION_SET_STICKER",
  EVENT_TEACHER_ANNOTATION_CLEAR_STICKER = "EVENT_TEACHER_ANNOTATION_CLEAR_STICKER"
}
